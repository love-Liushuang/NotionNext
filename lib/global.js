...
import { THEMES, initDarkMode, saveDarkModeToCookies, saveIsShowSearchInputToCookies } from '@/themes/theme'
...
export function GlobalContextProvider(props) {
  ...
  const toggleDarkMode = () => {
    ...
    // 是否展示搜索框
    // const initIsShowSearchInput = () => {
        saveIsShowSearchInputToCookies(router?.query?.isShowSearchInput || false)
    // }
  ...
  console.log('*********', children, NOTION_CONFIG,
    siteInfo,
    categoryOptions,
    tagOptions);
